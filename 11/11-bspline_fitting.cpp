...
int main(int argc, char *argv[])
{
	...
	ON_NurbsCurve curve_nurbs = pcl::on_nurbs::FittingCurve2dAPDM::initCPsNurbsCurve2D(order, curve_data.interior);
	...
	// save trimmed b-spliner surface
	if (fit.m_nurbs.IsValid())
	{
		...
		curv.m_object = new ON_NurbsSurface(fit.m_nurbs);
